"""
Django settings for custom_dj project.
...
SECRET_KEY = '4v^wwb!tr)gm!ej-!ecwf2izoy0bjm-aqh*3r=#5k0=9ulau+@'
...
WSGI_APPLICATION = 'custom_dj.wsgi.application'
